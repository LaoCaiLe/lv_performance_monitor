...
LV_FONT_DECLARE(JetBrains_Momo_24)
...
void lv_monitor_base_init(void)
{
    ...
    lv_style_set_text_font(&default_style, &JetBrains_Momo_24);
}
...
void lv_monitor_task_counter_init(void)
{
    ...
    lv_style_set_text_font(&font_style, &JetBrains_Momo_24);
    lv_obj_add_style(title, &default_style, LV_PART_MAIN);
...
void lv_monitor_uptime_init(void)
{
    ...
    lv_obj_add_style(text, &default_style, LV_PART_MAIN);
    lv_obj_set_style_text_font(text, &JetBrains_Momo_24, LV_PART_MAIN);
